import { renderWebComponentDemoPage } from "./render-web-component"

export function mountWebComponentDemoPage(root: HTMLElement): void {
  root.innerHTML = renderWebComponentDemoPage()
