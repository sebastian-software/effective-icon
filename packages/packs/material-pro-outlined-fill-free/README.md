...
Redistributed Streamline icon pack for Streamline Material Outlined Fill Free.

- Family: Streamline Material
- Style: Outlined Fill
- Icons: 50
- Source: https://www.streamlinehq.com/icons/material-pro-outlined-fill-free
- Browse icons: https://sebastian-software.github.io/effective-icon/packs/material-pro-outlined-fill-free/
- License: CC BY 4.0
...
```bash
npm install @icon-pkg/streamline-material-pro-outlined-fill-free
```
