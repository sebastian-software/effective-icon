...
Redistributed Streamline icon pack for Core Remix Free.

- Family: Core
- Style: remix
- Icons: 998
- Source: https://www.streamlinehq.com/icons/core-remix-free
- Browse icons: https://sebastian-software.github.io/effective-icon/packs/core-remix-free/
- License: CC BY 4.0
...
```bash
npm install @icon-pkg/streamline-core-remix-free
```
