...
Redistributed Streamline icon pack for Streamline Material Sharp Fill Free.

- Family: Streamline Material
- Style: Sharp Fill
- Icons: 50
- Source: https://www.streamlinehq.com/icons/material-pro-sharp-fill-free
- Browse icons: https://sebastian-software.github.io/effective-icon/packs/material-pro-sharp-fill-free/
- License: CC BY 4.0
...
```bash
npm install @icon-pkg/streamline-material-pro-sharp-fill-free
```
