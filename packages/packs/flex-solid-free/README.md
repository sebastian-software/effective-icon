...
Redistributed Streamline icon pack for Flex Solid Free.

- Family: Flex
- Style: solid
- Icons: 499
- Source: https://www.streamlinehq.com/icons/flex-solid-free
- Browse icons: https://sebastian-software.github.io/effective-icon/packs/flex-solid-free/
- License: CC BY 4.0
...
```bash
npm install @icon-pkg/streamline-flex-solid-free
```
