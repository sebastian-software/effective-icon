...
function renderIndexHtml(): string {
  ...
  const descriptions: Record<string, string> = {
    ...
    "web-component":
      "Custom <code>&lt;streamline-icon&gt;</code> element with shadow DOM mask. Tintable, framework-agnostic.",
  }
...
<html lang="en">
  <head>
    ...
    <title>vite-plugin-streamline — compile-time icon resolution</title>
    <meta name="description" content="Resolve Streamline icons at compile time into image, mask, inline SVG, or web component output." />
    <style>
  ...
  <body>
    <header class="topbar"><div class="topbar__inner"><span class="topbar__name">vite-plugin-streamline</span></div></header>
    <main>
      ...
      <footer class="page-footer">
        <span>vite-plugin-streamline</span>
